---
title: "GITR Analysis in Lymphoid Neoplasm Diffuse Large B-cell Lymphoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_dlbc.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('DLBC', 'DLBC', 'DLBC', 'DLBC'))
```
...
write.table(combined, file='fdr_ipa_tables/gitr_dlbc.tsv', row.names=FALSE, quote=FALSE, sep='\t')
