---
title: "GITR Analysis in Acute Myeloid Leukemia"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
# Examining GITR Expression in Low PDL1 Expressing Tumors
...
master <- master %>% subset(select=c(-quartile_foxp3, -quartile_ctla4,-quartile_lag3,-quartile_csf1r,-quartile_tim3))
...
write.fit(tfit,dt,file='results_gitr_acute_myeloid_leukemia.txt')
```
...
write.table(combined, file='fdr_ipa_tables/gitr_AML.tsv', row.names=FALSE, quote=FALSE, sep='\t')
