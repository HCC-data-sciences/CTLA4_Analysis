---
title: "GITR Analysis in Kidney renal clear cell carcinoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
#PDL1 only 1.4 fold lower in G2 than G1
...
write.fit(tfit,dt,file='results_gitr_renal_clear_cell.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('KIRC', 'KIRC', 'KIRC', 'KIRC'))
```
...
write.table(combined, file='fdr_ipa_tables/gitr_renal_clear_cell.tsv', row.names=FALSE, quote=FALSE, sep='\t')
