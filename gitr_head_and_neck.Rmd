---
title: "GITR Analysis in Head and Neck Squamous Cell Carcinoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_head_and_neck.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('HNSC', 'HNSC', 'HNSC', 'HNSC'))
```
...
write.table(combined, file='fdr_ipa_tables/gitr_head_neck.tsv', row.names=FALSE, quote=FALSE, sep='\t')
