---
title: "GITR Analysis in Pancreatic Adenocarcinoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
# Only 1.1 log fold change between G1 and G2 for PDL1
...
write.fit(tfit,dt,file='results_gitr_pancreatic.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('PAAD', 'PAAD', 'PAAD', 'PAAD'))
```
