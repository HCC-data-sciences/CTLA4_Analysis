---
title: "CTLA-4 Analysis in Cholangiocarcinoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
```{r load_chol_data, cache=TRUE, include=FALSE, eval=TRUE}
query.chol.hg38 <- GDCquery(project = c("TCGA-CHOL"),
                            data.category = "Transcriptome Profiling",
                            data.type = "Gene Expression Quantification",
                            #sample.type = "Metastatic",
                            workflow.type = "STAR - Counts"
                        )
GDCdownload(query.chol.hg38)
raw.counts <- GDCprepare(query = query.chol.hg38, summarizedExperiment = FALSE)

```


```{r generate_edge_r_object, dependson='load_chol_data'}
...
write.fit(tfit,dt,file='results_cholangiocarcinoma.txt')
```
...
group_res_timer <- deconvolute(by_group_joined, 'timer', indications=c('CHOL','CHOL','CHOL','CHOL'))
group_res_consensus_tme <- deconvolute(by_group_joined, 'consensus_tme', indications=c('CHOL','CHOL','CHOL','CHOL'))
```
