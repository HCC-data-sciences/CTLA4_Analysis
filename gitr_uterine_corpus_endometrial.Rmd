---
title: "GITR Analysis in Uterine Corpus Endometrial Carcinoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_uterine_corpus_endometrial.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('UCEC', 'UCEC', 'UCEC', 'UCEC'))
```
...
write.table(combined, file='new_ipa_table/gitr_uterine_corpus.tsv', row.names=FALSE, quote=FALSE, sep='\t')
