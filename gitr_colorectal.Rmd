---
title: "GITR Analysis in Colorectal Cancer"
author: "Arjun Mittal"
date: "June 23, 2022"
output:
    html_document:
...
The overall goal of this analysis is to figure out what genes are differentially expressed in a GITR high expression and T cell cold condition. To examine this, 368 metastatic melanoma samples from TCGA were analyzed
...
write.fit(tfit,dt,file='results_gitr_colorectal.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('COAD', 'COAD', 'COAD', 'COAD'))
```
...
write.table(combined, file='fdr_ipa_tables/gitr_colorectal.tsv', row.names=FALSE, quote=FALSE, sep='\t')
...
write.table(combined, file='new_ipa_table/gitr_colorectal.tsv', row.names=FALSE, quote=FALSE, sep='\t')
