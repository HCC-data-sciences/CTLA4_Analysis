---
title: "GITR Analysis in Prostate Adenocarcinoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_prostate.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('PRAD', 'PRAD', 'PRAD', 'PRAD'))
```
...
write.table(combined, file='new_ipa_table/gitr_prostate.tsv', row.names=FALSE, quote=FALSE, sep='\t')
