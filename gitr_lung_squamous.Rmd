---
title: "GITR Analysis in Lung Squamous Cell Carcinoma"
author: "Arjun Mittal"
date: "June 23, 2022"
output:
    html_document:
...
# Examining GITR High vs GITR Low Expression in Lung Squamous Cell Carcinoma Tumors
...
write.fit(tfit,dt,file='results_gitr_lung_squamous.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('LUSC', 'LUSC', 'LUSC', 'LUSC'))
```
