---
title: "GITR Analysis in Esophageal Carcinoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_esophageal.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('ESCA', 'ESCA', 'ESCA', 'ESCA'))
```
...
write.table(combined, file='fdr_ipa_tables/gitr_esophageal.tsv', row.names=FALSE, quote=FALSE, sep='\t')
