---
title: "GITR Analysis in Testicular Germ Cell Tumors"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_testicular.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('TGCT', 'TGCT', 'TGCT', 'TGCT'))
```
...
write.table(combined, file='fdr_ipa_tables/gitr_testicular.tsv', row.names=FALSE, quote=FALSE, sep='\t')
