---
title: "GITR Analysis in Cervical squamous cell carcinoma and endocervical adenocarcinoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_cervical.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('CESC', 'CESC', 'CESC', 'CESC'))
```
...
write.table(combined, file='new_ipa_table/gitr_cervical.tsv', row.names=FALSE, quote=FALSE, sep='\t')
