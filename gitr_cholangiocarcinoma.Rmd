---
title: "GITR Analysis in Cholangiocarcinoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_cholangiocarcinoma.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('CHOL', 'CHOL', 'CHOL', 'CHOL'))
```
...
write.table(combined, file='new_ipa_table/gitr_cholangio.tsv', row.names=FALSE, quote=FALSE, sep='\t')
