---
title: "GITR Analysis in Metastatic Melanoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_metastatic_melanoma.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('SKCM', 'SKCM', 'SKCM', 'SKCM'))
```
...
write.table(combined, file='fdr_ipa_tables/gitr_melanoma.tsv', row.names=FALSE, quote=FALSE, sep='\t')
...
write.table(combined, file='new_ipa_table/gitr_melanoma.tsv', row.names=FALSE, quote=FALSE, sep='\t')
