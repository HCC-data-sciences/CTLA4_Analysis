---
title: "CTLA-4 Analysis in Glioblastome Multiforme"
author: "Arjun Mittal"
date: "June 23, 2022"
output:
    html_document:
...
```{r load_gbm_data, cache=TRUE, include=FALSE, eval=TRUE}
query.gbm.hg38 <- GDCquery(project = c("TCGA-GBM"),
                            data.category = "Transcriptome Profiling",
                            data.type = "Gene Expression Quantification",
                            #sample.type = "Metastatic",
                            workflow.type = "STAR - Counts"
                        )
GDCdownload(query.gbm.hg38)
raw.counts <- GDCprepare(query = query.gbm.hg38, summarizedExperiment = FALSE)

```


```{r generate_edge_r_object, dependson='load_gbm_data'}
