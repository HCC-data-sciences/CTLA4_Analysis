---
title: "CTLA-4 Analysis in Sarcoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
```{r load_sarc_data, cache=TRUE, include=FALSE, eval=TRUE}
query.sarc.hg38 <- GDCquery(project = c("TCGA-SARC"),
                            data.category = "Transcriptome Profiling",
                            data.type = "Gene Expression Quantification",
                            #sample.type = "Metastatic",
                            workflow.type = "STAR - Counts"
                        )
GDCdownload(query.sarc.hg38)
raw.counts <- GDCprepare(query = query.sarc.hg38, summarizedExperiment = FALSE)

```


```{r generate_edge_r_object, dependson='load_sarc_data'}
...
write.fit(tfit,dt,file='results_sarcoma.txt')
```
...
group_res_timer <- deconvolute(by_group_joined, 'timer', indications=c('SARC','SARC','SARC','SARC'))
group_res_consensus_tme <- deconvolute(by_group_joined, 'consensus_tme', indications=c('SARC','SARC','SARC','SARC'))
```
