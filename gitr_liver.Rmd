---
title: "GITR Analysis in Liver hepatocellular carcinoma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_liver.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('LIHC', 'LIHC', 'LIHC', 'LIHC'))
```
...
write.table(combined, file='fdr_ipa_tables/gitr_liver.tsv', row.names=FALSE, quote=FALSE, sep='\t')
