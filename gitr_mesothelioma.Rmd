---
title: "GITR Analysis in Mesothelioma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
write.fit(tfit,dt,file='results_gitr_mesothelioma.txt')
```
...
group_res_consensus_tme <- deconvolute(by_group_joined, 'mcp_counter', indications=c('MESO', 'MESO', 'MESO', 'MESO'))
```
