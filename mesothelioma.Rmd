---
title: "CTLA-4 Analysis in Mesothelioma"
author: "Arjun Mittal"
date: "July 8, 2022"
output:
    html_document:
...
```{r load_meso_data, cache=TRUE, include=FALSE, eval=TRUE}
query.meso.hg38 <- GDCquery(project = c("TCGA-MESO"),
                            data.category = "Transcriptome Profiling",
                            data.type = "Gene Expression Quantification",
                            #sample.type = "Metastatic",
                            workflow.type = "STAR - Counts"
                        )
GDCdownload(query.meso.hg38)
raw.counts <- GDCprepare(query = query.meso.hg38, summarizedExperiment = FALSE)

```


```{r generate_edge_r_object, dependson='load_meso_data'}
...
write.fit(tfit,dt,file='results_mesothelioma.txt')
```
...
group_res_timer <- deconvolute(by_group_joined, 'timer', indications=c('MESO','MESO','MESO','MESO'))
group_res_consensus_tme <- deconvolute(by_group_joined, 'consensus_tme', indications=c('MESO','MESO','MESO','MESO'))
```
