...
```{r quanti_seq_celltype_by_group, results='asis'}
...
```{r group_breakdowns_summed, include=FALSE}
...
```{r deconvolute_group_totals, cache=TRUE, include=FALSE}
...
```{r group_deconv_plotting, results='asis', fig.height=10, fig.width=9}
...
```{r plotXCell, results='asis', fig.height=20, fig.width=12}
cat('\n\n\n\n')
cat('### xCell Results')
...
```{r quantiseq_stat, include=FALSE}
...
```{r stat_t_reg_and_fibro, include=FALSE}
